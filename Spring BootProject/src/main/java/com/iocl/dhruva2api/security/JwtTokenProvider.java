package com.iocl.dhruva2api.security;
...
public class JwtTokenProvider {
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder().setSubject(userPrincipal.getUsername()).setIssuedAt(new Date()).setNotBefore(new Date())
    ...
    // public Authentication getAuthentication(String token, String username, String
    // password) {

...
public class DOLeaderboard {
    ...
    /**
     * @param telecall the telecall to set
     */
    ...
    /**
     * @param telecallRank the telecallRank to set
     */
    ...
    public int hashCode() {
        return Objects.hash(activityCompletion, activityCompletionRank, attainer, attainerRank, awesum, awesumRank,
                ...
                doCode, doMaster, facilityCompletion, facilityCompletionRank, finalDhruvaIndex, fit, fitRank, foQuiz,
                foQuizRank, mPower, mPowerRank, rank, rca, rcaRank, sauKaSankalp, sauKaSankalpRank, seva, sevaRank,
                soMaster, spotCheck, spotCheckRank, telecall, telecallRank, totalDhruva, updatedOn, xperience,
                xperienceRank);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof DOLeaderboard))
            return false;
        DOLeaderboard other = (DOLeaderboard) obj;
        return Objects.equals(activityCompletion, other.activityCompletion)
                ...
                && Objects.equals(doCode, other.doCode) && Objects.equals(doMaster, other.doMaster)
                ...
                && Objects.equals(fitRank, other.fitRank) && Objects.equals(foQuiz, other.foQuiz)
                && Objects.equals(foQuizRank, other.foQuizRank) && Objects.equals(mPower, other.mPower)
                && Objects.equals(mPowerRank, other.mPowerRank) && Objects.equals(rank, other.rank)
                && Objects.equals(rca, other.rca) && Objects.equals(rcaRank, other.rcaRank)
                && Objects.equals(sauKaSankalp, other.sauKaSankalp)
                ...
                && Objects.equals(telecall, other.telecall) && Objects.equals(telecallRank, other.telecallRank)
    ...
    public String toString() {
        return "DOLeaderboard [activityCompletion=" + activityCompletion + ", activityCompletionRank="
                ...
                + ", dhruvaCompliant=" + dhruvaCompliant + ", dhruvaCompliantRank=" + dhruvaCompliantRank + ", doCode="
                + doCode + ", doMaster=" + doMaster + ", facilityCompletion=" + facilityCompletion
                + ", facilityCompletionRank=" + facilityCompletionRank + ", finalDhruvaIndex=" + finalDhruvaIndex
                + ", fit=" + fit + ", fitRank=" + fitRank + ", foQuiz=" + foQuiz + ", foQuizRank=" + foQuizRank
                + ", mPower=" + mPower + ", mPowerRank=" + mPowerRank + ", rank=" + rank + ", rca=" + rca + ", rcaRank="
                + rcaRank + ", sauKaSankalp=" + sauKaSankalp + ", sauKaSankalpRank=" + sauKaSankalpRank + ", seva="
                + seva + ", sevaRank=" + sevaRank + ", soMaster=" + soMaster + ", spotCheck=" + spotCheck
                + ", spotCheckRank=" + spotCheckRank + ", telecall=" + telecall + ", telecallRank=" + telecallRank
                + ", totalDhruva=" + totalDhruva + ", updatedOn=" + updatedOn + ", xperience=" + xperience
                + ", xperienceRank=" + xperienceRank + "]";
    }

...
/**
 * SpotCheckComplianceFO
 */
@Entity
@Table(name = "VW_SPOT_CHECK_COMP_FO")
public class SpotCheckComplianceFO {
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof SpotCheckComplianceFO))
			return false;
		SpotCheckComplianceFO other = (SpotCheckComplianceFO) obj;
	...
	public String toString() {
		return "SpotCheckComplianceFO [inspNo=" + inspNo + ", location=" + location + ", roCode=" + roCode + ", roName="

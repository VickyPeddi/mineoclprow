...
@Component({
	selector: 'app-mis-sel-off-archetype-phase-quarter-index-consolidate-site',
	templateUrl: './mis-sel-off-archetype-phase-quarter-index-consolidate-site.component.html',
	styleUrls: ['./mis-sel-off-archetype-phase-quarter-index-consolidate-site.component.css']
})
export class MisSelOffArchetypePhaseQuarterIndexConsolidateSiteComponent implements OnInit {
	...
	onResetForm() {
		this.misParametersInputForm = new FormGroup({
			...
			'financialQuarter': new FormControl('1'),

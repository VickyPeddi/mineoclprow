...
@Component({
	selector: 'app-mis-sel-off-archetype-phase-quarter-index-parameter-site',
	templateUrl: './mis-sel-off-archetype-phase-quarter-index-parameter-site.component.html',
	styleUrls: ['./mis-sel-off-archetype-phase-quarter-index-parameter-site.component.css']
})
export class MisSelOffArchetypePhaseQuarterIndexParameterSiteComponent implements OnInit {

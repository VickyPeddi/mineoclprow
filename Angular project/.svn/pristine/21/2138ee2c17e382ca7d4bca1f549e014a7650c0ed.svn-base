...
@Component({
	selector: 'app-mis-sel-off-consolidate-site',
	templateUrl: './mis-sel-off-consolidate-site.component.html',
	styleUrls: ['./mis-sel-off-consolidate-site.component.css']
})
export class MisSelOffConsolidateSiteComponent implements OnInit {

...
@Component({
  selector: 'app-mis-sel-off-archetype-phase-year-index-consolidate-site',
  templateUrl: './mis-sel-off-archetype-phase-year-index-consolidate-site.component.html',
  styleUrls: ['./mis-sel-off-archetype-phase-year-index-consolidate-site.component.css']
})
export class MisSelOffArchetypePhaseYearIndexConsolidateSiteComponent implements OnInit {

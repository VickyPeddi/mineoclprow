...
@Component({
  selector: 'app-do-seva-dashboard',
  templateUrl: './do-seva-dashboard.component.html',
  styleUrls: ['./do-seva-dashboard.component.css']
})
export class DOSevaDashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataProviderService.loadDivisionSEVAScoreData(this.currentSoData).subscribe(data => {

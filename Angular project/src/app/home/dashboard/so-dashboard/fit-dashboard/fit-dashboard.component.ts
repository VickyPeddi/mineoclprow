...
@Component({
  ...
  templateUrl: './fit-dashboard.component.html',
  styleUrls: ['./fit-dashboard.component.css']
})
export class FitDashboardComponent implements OnInit {
  ...
  ngOnInit() {
    this.dataProviderService.loadStateFITScoreData().subscribe(data => {

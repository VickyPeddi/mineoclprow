...
@Component({
  selector: 'app-mis-sel-off-date-range-consolidate',
  templateUrl: './mis-sel-off-date-range-consolidate.component.html',
  styleUrls: ['./mis-sel-off-date-range-consolidate.component.css']
})
export class MisSelOffDateRangeConsolidateComponent implements OnInit {

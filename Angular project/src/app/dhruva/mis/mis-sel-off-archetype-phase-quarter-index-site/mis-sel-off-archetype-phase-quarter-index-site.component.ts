...
@Component({
	selector: 'app-mis-sel-off-archetype-phase-quarter-index-site',
	templateUrl: './mis-sel-off-archetype-phase-quarter-index-site.component.html',
	styleUrls: ['./mis-sel-off-archetype-phase-quarter-index-site.component.css']
})
export class MisSelOffArchetypePhaseQuarterIndexSiteComponent implements OnInit {

...
@Component({
	selector: 'app-mis-sel-off-archetype-phase-quarter-site',
	templateUrl: './mis-sel-off-archetype-phase-quarter-site.component.html',
	styleUrls: ['./mis-sel-off-archetype-phase-quarter-site.component.css']
})
export class MisSelOffArchetypePhaseQuarterSiteComponent implements OnInit {

<%-- 
    Document   : stateWiseRO
    Created on : Jun 12, 2017, 11:26:56 AM
    Author     : t_sipu
--%>
                                    ...
                                    <select  id="state">
                                        <%
                                            ...
                                            try {
                                                ...
                                                rs = st.executeQuery("select distinct CUST_STATE_NAME,CUST_STATE from IOCL_MD_AOD_SALES order by CUST_STATE_NAME");
                                                while (rs.next()) {%>
                                        <option value="<%=rs.getString("CUST_STATE")%>"><%=rs.getString("CUST_STATE_NAME")%></option>
                                        <%

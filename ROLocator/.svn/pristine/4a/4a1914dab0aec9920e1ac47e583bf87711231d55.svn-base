<%-- 
    Document   : districtWiseRO
    Created on : Jun 12, 2017, 11:27:10 AM
    Author     : t_sipu
--%>
    ...
    <head>
        ...
        <script>
            ...
            function initialize()
            {
                ...
                for (i = 1; i < locations.length; i++) {
                    marker = new google.maps.Marker({
                        ...
                        icon: locations[i].split(",")[38] === 'Y' ? './images/covid-special.png' : './images/petrol.png'});
                }
                    ...
                    google.maps.event.addListener(marker, 'click', (function (marker, i) {
                        return function () {
                            ...
                            var str = "<tr><td colspan='2'><b>Product & Price</b></td></tr><table border='1' width='100%'>" +
                                    ...
                                    ((locDetails[41] != ' ' && locDetails[41] != '0' && locDetails[41] != 'Not Available') ?
                                    ...
                                    ((locDetails[41] != ' ' && locDetails[41] != '0' && locDetails[41] != 'Not Available') ?
                                            "<td align='center'>Rs. " + locDetails[41].toString() + "/Litre</td>"
                                            : "") + ((locDetails[42] != ' ' && locDetails[42] != '0' && locDetails[42] != 'Not Available') ?
                            ...
                            infowindow.setContent("<div><table> " +
                                    ...
                                    "<tr><td class='wrapword' colspan='2'><b><font color='blue'>" + locDetails[0] + " (" + locDetails[37] + ")</font></b></td></tr>" +
                                    ...
                                    ((locDetails[38].toUpperCase() == 'Y') ?
                                            "<tr><td>COVID-19 --FOOD & RELIEF -- " + locDetails[39] + " [" + locDetails[40] + "]</td><td align='center'><img src='./images/covid.png' width='100' height='100'/></tr>"
                                            : "") +
            ...
            function codeAddress() {
                ...
                $.ajax({
                    url: "./DistrictWiseLocator",
                    type: "POST",
                    data: {district: $("#district :selected").val()},
                    async: false,
            ...
            function generateTable() {
                ...
                str += "<tr><th>Sr.</th><th>RO Code</th><th>Petrol Pump Name</th><th>COVID-19 Food & Relief Contact</th><th>Address</th><th>Dealer/Partner/Operator/Contact Person Name</th><th>Contact No</th>\n\
        <th>Petrol Price</th><th>Diesel Price</th><th>XTRAPREMIUM Price</th><th>XTRAMILE Price</th><th>XP100 Price</th><th>XP95 Price</th><th>XG Price</th><th>E100 Price</th><th>District</th><th>State</th>" +
                        "<th>State Office</th><th>Divisional Office</th><th>Sales Area</th><th>Sales Officer Contact No</th></tr>"
                var columnCount = locations[0].split(",").length;
                for (var i = 0; i < locations.length - 1; i++) {
                    var a = "", b = "", c = "", d = "", e = "", f = "", g = "", h = "", k = "", m = "", ms = "", hsd = "", xp = "", xm = "", rocode = "";
                    var covideliefContact = "", xp100 = "", xp95 = "", xg = "", e100 = "";
                    str += "<tr><td>" + (i + 1) + "</td>";
                    ...
                    str += rocode + f + covideliefContact + g + b + m + ms + hsd + xp + xm + xp100 + xp95 + xg + e100 + a + c + d + e + h + k + "</tr>";
                }
                                    ...
                                    <select   id="district">
                                        <%
                                            ...
                                            try {
                                                ...
                                                rs = st.executeQuery("select distinct DISTRICT_NAME,DISTRICT from IOCL_MD_AOD_SALES order by DISTRICT_NAME");
                                                while (rs.next()) {%>
                                        <option value="<%=rs.getString("DISTRICT")%>"><%=rs.getString("DISTRICT_NAME")%></option>
                                        <%
